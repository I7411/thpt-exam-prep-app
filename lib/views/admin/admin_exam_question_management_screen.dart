...
class AdminExamQuestionManagementScreen extends StatefulWidget {
  ...
  @override
  State<AdminExamQuestionManagementScreen> createState() => _AdminExamQuestionManagementScreenState();
}

class _AdminExamQuestionManagementScreenState extends State<AdminExamQuestionManagementScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final exams = provider.examSummaries.where((item) => _selectedSubjectId == null || item.exam.subjectId == _selectedSubjectId).toList();
...
class _ExamCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final questions = provider.exams.where((exam) => exam.id == item.exam.id).length;
    final relatedQuestions = provider.examSummaries.firstWhere((exam) => exam.exam.id == item.exam.id).questionCount;
...
class MockExamQuestionPreview {
  ...
  const MockExamQuestionPreview({required this.orderNumber, required this.content, required this.correctAnswer, required this.difficulty});
