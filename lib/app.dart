  ...
  Route<dynamic>? _generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case AppRoutes.studentHome:
        return MaterialPageRoute(builder: (_) => const StudentMainScreen(), settings: settings);
      case AppRoutes.studentSubjects:
        return MaterialPageRoute(builder: (_) => const SubjectListScreen(), settings: settings);
      case AppRoutes.studentDocuments:
        return MaterialPageRoute(
          builder: (_) => DocumentListScreen(initialSubjectId: args is String ? args : null),
          settings: settings,
        );
      case AppRoutes.studentDocumentDetail:
        ...
        return MaterialPageRoute(builder: (_) => DocumentDetailScreen(document: args), settings: settings);
      case AppRoutes.studentExams:
        return MaterialPageRoute(
          builder: (_) => ExamListScreen(initialSubjectId: args is String ? args : null),
          settings: settings,
        );
        ...
        if (args is! Exam) {
          return MaterialPageRoute(
            builder: (_) => const PlaceholderScreen(
              ...
              description: 'Thiếu dữ liệu đề thi để bắt đầu làm bài.',
            ),
            settings: settings,
          );
        }
        return MaterialPageRoute(builder: (_) => ExamTakingScreen(exam: args), settings: settings);
      case AppRoutes.studentExamResult:
        return MaterialPageRoute(builder: (_) => const ExamResultScreen(), settings: settings);
      case AppRoutes.studentProgress:
        return MaterialPageRoute(builder: (_) => const ProgressScreen(), settings: settings);
      ...
      case AppRoutes.teacherDashboard:
        return MaterialPageRoute(builder: (_) => const TeacherDashboardScreen(), settings: settings);
      case AppRoutes.teacherClasses:
        return MaterialPageRoute(builder: (_) => const TeacherClassListScreen(), settings: settings);
      case AppRoutes.teacherClassDetail:
        return MaterialPageRoute(
          builder: (_) => TeacherClassDetailScreen(classId: args is String ? args : null),
          settings: settings,
        );
      case AppRoutes.teacherQuestions:
        return MaterialPageRoute(builder: (_) => const TeacherQuestionBankScreen(), settings: settings);
      case AppRoutes.teacherSchedule:
        return MaterialPageRoute(builder: (_) => const TeacherScheduleScreen(), settings: settings);
      case AppRoutes.teacherProfile:
        return MaterialPageRoute(builder: (_) => const TeacherProfileScreen(), settings: settings);
      ...
      case AppRoutes.adminDocuments:
        return MaterialPageRoute(builder: (_) => const AdminDocumentManagementScreen(), settings: settings);
      case AppRoutes.adminExams:
        return MaterialPageRoute(builder: (_) => const AdminExamQuestionManagementScreen(), settings: settings);
      case AppRoutes.adminReports:
        return MaterialPageRoute(builder: (_) => const AdminReportsScreen(), settings: settings);
