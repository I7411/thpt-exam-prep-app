...
class StudentProgress {
  ...
  factory StudentProgress.fromJson(Map<String, dynamic> json) {
    final subjectProgressList =
        (json['subjectProgress'] as List<dynamic>?)
    ...
    return StudentProgress(
      ...
      totalExamsCompleted:
          json['totalExamsCompleted'] as int? ??
          json['totalExamsTaken'] as int? ??
          0,
      averageScore: (json['averageScore'] as num? ?? 0.0).toDouble(),
      documentsRead:
          json['documentsRead'] as int? ??
          json['totalDocumentsRead'] as int? ??
          0,
      activeSubjects:
          json['activeSubjects'] as int? ?? subjectProgressList.length,
      overallProgressPercentage:
          (json['overallProgressPercentage'] as num? ??
  ...
  factory StudentProgress.fromFirestore(
    DocumentSnapshot<Map<String, dynamic>> doc,
  ) {
    final data = doc.data() ?? {};
    final subjectProgressList =
        (data['subjectProgress'] as List<dynamic>?)
            ?.map(
              (e) => ProgressStat.fromJson(Map<String, dynamic>.from(e as Map)),
            )
            .toList() ??
        [];
    ...
    return StudentProgress(
      ...
      totalExamsCompleted:
          data['totalExamsCompleted'] as int? ??
          data['totalExamsTaken'] as int? ??
          0,
      averageScore: (data['averageScore'] as num? ?? 0.0).toDouble(),
      documentsRead:
          data['documentsRead'] as int? ??
          data['totalDocumentsRead'] as int? ??
          0,
      activeSubjects:
          data['activeSubjects'] as int? ?? subjectProgressList.length,
      overallProgressPercentage:
          (data['overallProgressPercentage'] as num? ??
                  data['completionPercentage'] as num? ??
                  0.0)
              .toDouble(),
      subjectProgress: subjectProgressList,
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      'examsPassed': subjectProgress.fold<int>(
        0,
        (total, e) => total + e.examsPassed,
      ), // Legacy compatibility
      'streakDays': subjectProgress.fold<int>(
        0,
        (max, e) => e.streakDays > max ? e.streakDays : max,
      ), // Legacy compatibility
