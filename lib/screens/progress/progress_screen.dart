...
class _ProgressScreenState extends State<ProgressScreen> {
  ...
  void didChangeDependencies() {
    ...
    context.read<ProgressProvider>().initialize(studentId);
    _initialized = true;
  }
  ...
  Widget _buildSummaryGrid(BuildContext context, ProgressProvider provider) {
  ...
  Widget _buildStrengthCard(BuildContext context, ProgressProvider provider) {
    return Container(
  ...
  int _estimateDocumentsFromProgress(ProgressProvider provider) {
