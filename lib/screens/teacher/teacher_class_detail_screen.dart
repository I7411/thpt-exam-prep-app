...
class _TeacherClassDetailScreenState extends State<TeacherClassDetailScreen> {
  ...
  Future<void> _loadData() async {
    ...
    await context.read<TeacherProvider>().ensureLoaded(authProvider.currentUser);
  }
  ...
  Widget _buildHeader(BuildContext context, TeacherProvider teacherProvider, TeacherClass teacherClass) {
  ...
  Widget _buildStats(TeacherProvider teacherProvider, TeacherClass teacherClass) {
  ...
  Widget _buildStudents(TeacherProvider teacherProvider, TeacherClass teacherClass) {
    final students = teacherProvider.studentsForClass(teacherClass.id);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildRelatedExams(TeacherProvider teacherProvider, TeacherClass teacherClass) {
